...
#_(doto (System/getProperties) (.put "proxySet" "true") (.put "proxyHost" "sjd-entbc-001") (.put "proxyPort" "80"))
...
(doto
    (google-data-feed #_{:dt-range       ["2015-08-01" nil]
                  ...
                  #_{:client_id     "****"
                   ...
                   :account-name  "****"
                   :app-id        "****"
                   :out-columns   ["11790701364585954510" "Mobile Development eBay Denmark"  "dk.dba"
